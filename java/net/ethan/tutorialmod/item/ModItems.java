...
public class ModItems {
    ...
    public static final Item GRIM_SPAWN_EGG = registerItem("grim_spawn_egg",
            new SpawnEggItem(ModEntities.GRIM,0x0c082b,0x292263,new FabricItemSettings().group(ModItemGroup.MOD)));
