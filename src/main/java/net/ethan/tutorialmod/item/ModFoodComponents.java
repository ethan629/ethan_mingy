...
public class ModFoodComponents {
    ...
    public static final FoodComponent RAINBOW_OPAL_CARROT = (new FoodComponent.Builder()).hunger(5).saturationModifier(0.5F).statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 2400, 6), 1.0F).build();
