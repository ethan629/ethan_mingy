...
public class ModFoodComponents {
    public static final FoodComponent GARNET_CARROT = (new FoodComponent.Builder()).hunger(5).saturationModifier(0.5F).statusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 2400, 3), 1.0F).build();
    ...
    public static final FoodComponent TOURMALINE_CARROT = (new FoodComponent.Builder()).hunger(5).saturationModifier(0.5F).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 2400, 3), 1.0F).build();
}